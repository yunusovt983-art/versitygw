...
var (
	...
	// IPFS-specific actions
	ActionIPFSPin                = "ipfs_Pin"
	ActionIPFSUnpin              = "ipfs_Unpin"
	ActionIPFSClusterHealth      = "ipfs_ClusterHealth"
	ActionIPFSReplication        = "ipfs_Replication"
)
...
func init() {
	...
	// IPFS-specific actions
	ActionMap[ActionIPFSPin] = Action{
		Name:    "Pin",
		Service: "ipfs",
	}
	ActionMap[ActionIPFSUnpin] = Action{
		Name:    "Unpin",
		Service: "ipfs",
	}
	ActionMap[ActionIPFSClusterHealth] = Action{
		Name:    "ClusterHealth",
		Service: "ipfs",
	}
	ActionMap[ActionIPFSReplication] = Action{
		Name:    "Replication",
		Service: "ipfs",
	}
}
